...
uint8_t CTP_CFG_GT911[] =  {
    0x50,//Config_Version A(0x41)-Z 0x50-P
    0x00,0x04,//x_max 1024
    0x58,0x02,//y_max 600
    0x01,0x3C,0x00,0x02,0x2A,0x1E,0x0F,
    /*
    0x01:max out_point=1~10
    0x3D:Stylus_priority-00 Stretch_rank-11 x2y-1 Sito-1 INT-00
    0x00:Module_switch2
    0x02:Shake_Count
    0x2A:Filter
    0x1E:Large_Touch
    0x0F:Noise_Reduction
    */
    0x64,// Screen_Touch_Level
    0x46,//Screen_Leave_Level
    0x03,//Low_Power_Control
    0x0F,//Refresh_Rate
    0x00,0x00, 
    0x00,0x00,
    0x00,0x00,//Space
    ...
    0x18,//Stretch_R2
    0x14,//Stretch_RM
    0x8C,//Drv_GroupA_ Num
    0x2E,//Drv_GroupB_ Num
    0x0E,//Sensor_Num
    0x3D,//FreqA_factor
    0x46,//FreqB_factor
    0x0C,0x08,//Pannel_ BitFreqL Pannel_ BitFreqH 2060
    0x00,0x00,
    0x01,0x02,0x02,0x2D,0x00,0x01,0x00,0x00,0x00,0x00,0x64,0x32,
    0x00,0x00,0x00,0x28,0x78,0x94,0xC5,0x02,0x07,0x00,0x00,0x04,
    0xAA,0x2C,0x00,0x8D,0x37,0x00,0x75,0x45,0x00,0x62,0x56,0x00,
    0x53,0x6C,0x00,0x53,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
//    0x1E,
//    0x14,
//    0x8C,0x2C,0x0E,0x66,0x68,0x0C,
//    0x08,0x00,0x00,0x01,0x00,0x02,0x1D,0x14,0x01,0x00,0x00,
//    0x00,0x03,0x64,0x32,0x00,0x00,0x00,0x5A,0x8C,0x94,0xC5,
//    0x02,0x07,0x00,0x00,0x04,0x87,0x5E,0x00,0x80,0x66,0x00,
//    0x78,0x70,0x00,0x71,0x7A,0x00,0x6B,0x86,0x00,0x6B,0x00,
//    0x00,0x00,0x00,0xFF,0x45,0x45,0xFF,0xF0,0xFF,0x03,0x00,
...
//    0x28,0xFF,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
//    0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x32,0x01
};


uint8_t config[GTP_ADDR_LENGTH + GTP_CONFIG_MAX_LENGTH]
...
//    GTP_DEBUG("I2C finger:%X",finger);
    ...
    touch_x  = point_data[4] | (point_data[5] << 8);    //x坐标
    touch_y  = point_data[6] | (point_data[7] << 8);    //y坐标
    touch_w  = point_data[8] | (point_data[9] << 8);    //size
    is_touch=1;
